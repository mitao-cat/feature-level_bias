...
class NFM(BaseModel):
    ...
    def __init__(self,
                 ...
                 dnn_dropout=0, dnn_activation='relu', task='binary', device='cpu', gpus=None, use_bn=False):
        ...
        self.dnn = DNN(self.compute_input_dim(dnn_feature_columns, include_sparse=False) + self.embedding_size,
                       dnn_hidden_units,
                       activation=dnn_activation, l2_reg=l2_reg_dnn, dropout_rate=dnn_dropout, use_bn=use_bn,
